  ...
  return (
    <div className="max-w-100 lg:max-w-2/3 pt-8">
      ...
      <div id="chat" className="border-2 rounded-4xl p-4 lg:p-6">
        ...
        <ChatSite
          texto={
            "Tem certeza que ainda quer continuar com Java????"
          }
          hora="03:46"
        />
      </div>
          ...
          <div className="collapse-content text-base mx-auto text-center w-96 lg:w-fit lg:text-left">
            <div className="hero-content flex-col lg:flex-row-reverse">
              ...
              <div className='w-100 px-2 lg:w-fit lg:px-0'>
                ...
                <a
                  href="https://github.com/conteudoGeneration/cookbook_java_fullstack"
                  target="_blank"
                  className="btn btn-secondary"
                >
                  Ir para o site
            ...
            <div className="hero-content flex-col lg:flex-row-reverse">
              ...
              <div className='w-100 px-2 lg:w-fit lg:px-0'>
                ...
                <p className="py-6">
                  ...
                  tutoriais, referências e exemplos práticos sobre linguagens como
                  HTML, CSS, JavaScript, Python, SQL, PHP, Java, C++, além de
                  ...
                  facilita a prática imediata do conteúdo estudado. Além disso, o
                  site disponibiliza exercícios, quizzes e certificações oficiais
                  que podem ser adquiridas após a conclusão de cursos. É uma
                  ferramenta muito usada tanto por iniciantes que estão começando
                  na área de tecnologia quanto por profissionais que buscam uma
                  referência rápida e prática no dia a dia de desenvolvimento.
                </p>
                <a
            ...
            <div className="hero-content flex-col lg:flex-row-reverse">
              ...
              <div className='w-100 px-2 lg:w-fit lg:px-0'>
                ...
                <p className="py-6">
                  ...
                  acesso centralizado a documentações técnicas, guias de
                  desenvolvimento, tutoriais, referências de API, notas de versão,
                  recursos de licenciamento e muito mais, tanto para Java SE
                  (Standard Edition), Java EE (Enterprise Edition) quanto para
                  soluções embarcadas como Java ME e Java Card
                </p>
                <a
