function JsFront() {
  ...
  const extensoes = [
    ...
    },
    {
      ...
      descricao:
        'Renomeia automaticamente a tag de fechamento quando você altera a tag de abertura em arquivos HTML, JSX e similares.',
    ...
    },
    {
      ...
      descricao:
        'Destaca visualmente no editor os valores de cores (hex, rgb, hsl etc.), mostrando a cor correspondente diretamente no código.',
    ...
    },
    {
      ...
      descricao:
        'Fornece atalhos de código (snippets) para acelerar a escrita de componentes, hooks e estruturas comuns em React, Redux e React Native.',
    ...
    },
    {
      nome: 'Image preview',
      descricao:
        'Exibe pré-visualizações de imagens diretamente no código quando você passa o mouse sobre o caminho do arquivo.',
    ...
    },
    {
      ...
      descricao:
        'Adiciona autocompletar, realce de sintaxe e dicas para classes do Tailwind CSS, tornando o desenvolvimento mais rápido e confiável.',
      ...
      <main className="my-8 space-y-2">
          ...
          <div className="collapse-content text-base mx-auto text-center w-96 lg:w-fit lg:text-left">
            <div className="hero-content flex-col lg:flex-row-reverse">
              ...
              <div className="w-100 px-2 lg:w-fit lg:px-0">
                <h1 className="text-3xl lg:text-5xl font-bold">Roadmap 🚀</h1>
                <p className="py-6">
        ...
        <div className="collapse collapse-arrow bg-base-100 border border-base-content">
          ...
          <div className="collapse-content text-md">
            <ul className="flex flex-col text-center lg:text-left lg:list bg-base-100 rounded-box">
              {libframe.map((tecnologia, id) => (
                <li className="list-row items-center" key={id}>
                  <div>
                    <img
                      className="size-14 rounded-box bg-white p-2 mx-auto lg:items-start"
                      src={tecnologia.logo}
                    />
                  </div>
                  <div>
                  ...
                  <button className="btn btn-secondary p-2 mt-4 mb-8">
        ...
        <div className="collapse collapse-arrow bg-base-100 border border-base-content">
          ...
          <div className="collapse-content text-sm">
            ...
            <ul className="flex flex-col text-center lg:text-left lg:list bg-base-100 rounded-box mt-5">
              {extensoes.map((extensoes, id) => (
                <li className="list-row" key={id}>
                  <div>
                    <img
                      className="size-14 rounded-box bg-white p-1 mx-auto lg:items-start"
                      src={extensoes.logo}
                    />
                  </div>
                  <div>
