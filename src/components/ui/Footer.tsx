...
function Footer() {
  ...
  return (
    <div className="grid lg:grid-cols-3 gap-8 pt-2 pb-8 lg:pb-2 mb-4">
      ...
      <div className="flex flex-col justify-center items-center">
        <Link to='contato' className="badge badge-outline badge-info hover:bg-info hover:text-neutral px-8 text-lg font-semibold py-4 cursor-pointer">Envie sugestão de conteúdo aqui</Link>
      </div>
    </div>
  );
}
